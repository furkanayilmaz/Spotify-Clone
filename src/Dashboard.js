...
function Dashboard({ code }) {
    ...
    return (
        <div className={styles.background}>
            ...
            <h1 className={styles.navigatorHome} onClick={(e) => setCurrentPage('Home')}>Home</h1>
            ...
            <h1 className={styles.navigatorSearch} onClick={(e) => setCurrentPage('Search')}>Search</h1>
            ...
            <h1 className={styles.libraryNavigator} onClick={(e) => setCurrentPage('Library')}>Library</h1>
